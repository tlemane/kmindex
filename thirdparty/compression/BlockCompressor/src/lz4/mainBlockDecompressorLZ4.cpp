...
int main(int argc, char ** argv)
{
    if(argc != 6)
    {
        std::cout << "Usage: ./mainBlockDecompressorLZ4 <config_file> <matrix> <ef_path> <header> <output>\n\n";
        return 1;
    }   
    ...
    BlockDecompressorLZ4(config_path, in_path, ef_path, header_size).decompress_all(output);
}